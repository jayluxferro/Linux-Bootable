...
void ImageWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageWriter::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ImageWriter::*)(QString );
        ...
        {
            using _t = void (ImageWriter::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageWriter::blockWritten)) {
                *result = 4;
                return;
            }
        }
